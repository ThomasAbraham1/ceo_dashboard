        ...
        <div class="dlabnav">
			<div class="dlabnav-scroll">
				<ul class="metismenu" id="menu">
					...
					<!-- <li><a href="../Ceomoodule/finance.php" aria-expanded="false">
					...
					<!-- <li><a href="../SalesMarketingmodule/" class="" aria-expanded="false">
            ...
            <div class="container-fluid">
                <div class="row page-titles">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="../SalesMarketingmodule/fileUpload.php">File Upload</a></li>
                    </ol>
                </div>
                <div class="container">
                    <div class="header-section">
                        ...
                        <p>PDF, Word, Excel files are allowed.</p>
                    </div>
                    <div class="drop-section">
                        <div class="col">
                            <div class="cloud-icon">
                                <img src="../icons/fileuploadicons/cloud.png" alt="cloud">
                            </div>
