	...
	<div id="main-wrapper">
        ...
        ***********************************-->
		<div class="nav-header">
			<a href="FinancialStaffDasboard.php" class="brand-logo">
		...
		<div class="dlabnav">
			<div class="dlabnav-scroll">
				<ul class="metismenu" id="menu">
					...
					<li><a href="fileUpload.html" aria-expanded="false">
        ...
        ***********************************-->
		<div class="content-body">
			<div class="container-fluid">
				<div class="align-content" style="display: flex; justify-content: space-evenly;">
