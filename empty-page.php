  ...
  <div id="main-wrapper">
    ...
    <div class="nav-header">
      <a href="index.html" class="brand-logo">
        <img src="images/logo.jpg" class="logo-abbr" width="175" height="75" viewbox="0 0 5 55" />
    ...
    <a href="javascript:void(0);"><svg xmlns="" width="18px" height="18px" viewbox="0 0 24 24" version="1.1">
      ...
      <nav class="navbar navbar-expand">
        <div class="collapse navbar-collapse justify-content-between">
          ...
          <ul class="navbar-nav header-right">
            ...
            <li class="nav-item dropdown notification_dropdown">
              <!-- nav bar notification icons and dropdown-->
            ...
            <li class="nav-item dropdown header-profile">
              ...
              <div class="dropdown-menu dropdown-menu-end">
                ...
                <a href="email-inbox.html" class="dropdown-item ai-icon">
                  <svg id="icon-inbox" xmlns="" class="text-success" width="18" height="18" viewbox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                ...
                <a href="logout.php" class="dropdown-item ai-icon">
                  <svg id="icon-logout" xmlns="" class="text-danger" width="18" height="18" viewbox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
      ...
      <ul class="metismenu" id="menu">
        <li>
          <a class="has-arrow" href="javascript:void()" aria-expanded="false">
            <!--have to include the dashboard link-->
        ...
        <li>
          <a class="has-arrow" href="javascript:void()" aria-expanded="false">
            <!--have to include the finance link-->
            <i class="fas fa-circleinfo" aria-hidden="true"></i>
  ...
  <div class="footer">
    <div class="copyright">
      <p>
        ...
        <a href="../ceo_dashboard/empty-page.html" target="_blank">DexignLab</a> 2021 <?php echo $userId; ?>
      </p>
    </div>
  </div>
  <!--**********************************
