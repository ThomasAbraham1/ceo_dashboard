...
<body>
    ...
    ***********************************-->
		...
		<div class="dlabnav">
			<div class="dlabnav-scroll">
				<ul class="metismenu" id="menu">
					...
					<!-- </li> -->
					<li><a href="fileUpload.php" aria-expanded="false">
							<i class="fas fa-heart"></i>
							<span class="nav-text">Files Upload</span>
						</a>

					</li>
					<!-- <li><a href="../Financemodule/fileUpload.php" class="" aria-expanded="false">
		...
		<div class="content-body">
			<div class="container-fluid">
				...
				<div class="row page-titles">
					<ol class="breadcrumb">
						<li class="breadcrumb-item active"><a href="../Financemodule/ceo_dashboard.php">Dashboard</a></li>
						<li class="breadcrumb-item"><a href="../Financemodule/emailCompose.php">Email</a></li>
					</ol>
				</div>
	...
	<div class="footer">
		<div class="copyright">
			<p>Copyright © Designed &amp; Developed by <a href="javascript:void()" target="_blank">aron</a>2k23</p>
		</div>
	</div>
	<!--**********************************
            Footer end
