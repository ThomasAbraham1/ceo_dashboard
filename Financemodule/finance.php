    ...
    ***********************************-->
	<div id="main-wrapper">
		...
		<div class="dlabnav">
			<div class="dlabnav-scroll">
				<ul class="metismenu" id="menu">
					...
					<!-- <li><a href="alldata/sales.php" aria-expanded="false">
					...
					<!-- </li> -->
					<!-- <li><a href="alldata/marketing.php" aria-expanded="false">
        ...
        ***********************************-->
		<div class="footer">
			<div class="copyright">
				<p>Copyright © Designed &amp; Developed by <a href="javascript:void()">aron2k23</a></p>
			</div>
		</div>
		<!--**********************************
            Footer end
